...
instr_func opcode_entry[256] = {
    ...
    /* 0x0c - 0x0f*/ inv,inv,inv,opcode_2_byte,//or_i2a_b, or_i2a_v, inv, opcode_2_byte,
    ...
    /* 0xe8 - 0xeb*/ call_rel, jmp_near, inv, jmp_rel,
...
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, /*or_i2rm_v*/inv, /*adc_i2rm_v*/inv, /*sbb_i2rm_v*/inv,and_i2rm_bv, sub_i2rm_bv, /*xor_i2rm_v*/inv, cmp_i2rm_bv};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x84 - 0x87*/ inv, inv, jmp_imm_v_be, inv,
