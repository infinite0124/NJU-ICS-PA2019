...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ inv, lea_rm2r_v, inv,inv,//mov_rm2s_w, inv,
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near, jmp_ptr, jmp_short,
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ inv/*__ref_mov_c2r_l*/, inv,inv/* __ref_mov_r2c_l*/, inv,
