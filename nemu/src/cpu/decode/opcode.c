...
instr_func group_3_b_entry[8] =
    {test_i2rm_b, inv, not_rm_b, neg_rm_b, __ref_mul_rm2a_b, __ref_imul_rm2a_b, __ref_div_rm2a_b, __ref_idiv_rm2a_b};

/* 0xf7 */
instr_func group_3_v_entry[8] =
    {test_i2rm_v, inv, not_rm_v, neg_rm_v, __ref_mul_rm2a_v, __ref_imul_rm2a_v, __ref_div_rm2a_v, __ref_idiv_rm2a_v};
