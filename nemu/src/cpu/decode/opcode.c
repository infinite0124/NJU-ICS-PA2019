...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ add_r2rm_b,inv,inv,inv,//add_r2rm_b, add_r2rm_v, add_rm2r_b, add_rm2r_v,
    /* 0x04 - 0x07*/ inv,inv,inv,inv,//add_i2a_b, add_i2a_v, inv, inv,
    /* 0x08 - 0x0b*/ inv,inv,inv,inv,//or_r2rm_b, or_r2rm_v, or_rm2r_b, or_rm2r_v,
    /* 0x0c - 0x0f*/ inv,inv,inv,inv,//or_i2a_b, or_i2a_v, inv, opcode_2_byte,
    /* 0x10 - 0x13*/ inv,inv,inv,inv,//adc_r2rm_b, adc_r2rm_v, adc_rm2r_b, adc_rm2r_v,
    /* 0x14 - 0x17*/ inv,inv,inv,inv,//adc_i2a_b, adc_i2a_v, inv, inv,
    /* 0x18 - 0x1b*/ inv,inv,inv,inv,//sbb_r2rm_b, sbb_r2rm_v, sbb_rm2r_b, sbb_rm2r_v,
    /* 0x1c - 0x1f*/ inv,inv,inv,inv,//sbb_i2a_b, sbb_i2a_v, inv, inv,
    /* 0x20 - 0x23*/ inv,inv,inv,inv,//and_r2rm_b, and_r2rm_v, and_rm2r_b, and_rm2r_v,
    /* 0x24 - 0x27*/ inv,inv,inv,inv,//and_i2a_b, and_i2a_v, inv, inv,
    /* 0x28 - 0x2b*/ inv,inv,inv,inv,//sub_r2rm_b, sub_r2rm_v, sub_rm2r_b, sub_rm2r_v,
    /* 0x2c - 0x2f*/ inv,inv,inv,inv,//sub_i2a_b, sub_i2a_v, inv, inv,
    /* 0x30 - 0x33*/ inv,inv,inv,inv,//xor_r2rm_b, xor_r2rm_v, xor_rm2r_b, xor_rm2r_v,
    /* 0x34 - 0x37*/ inv,inv,inv,inv,//xor_i2a_b, xor_i2a_v, inv, inv,
    /* 0x38 - 0x3b*/ inv,inv,inv,inv,//cmp_r2rm_b, cmp_r2rm_v, cmp_rm2r_b, cmp_rm2r_v,
    /* 0x3c - 0x3f*/ inv,inv,inv,inv,//cmp_i2a_b, cmp_i2a_v, inv, inv,
    /* 0x40 - 0x43*/ inv, inv, inv, inv,
    /* 0x44 - 0x47*/ inv, inv, inv, inv,
    /* 0x48 - 0x4b*/ inv, inv, inv, inv,
    /* 0x4c - 0x4f*/ inv, inv, inv, inv,
    /* 0x50 - 0x53*/ push_gr, push_gr, push_gr, push_gr,
    /* 0x54 - 0x57*/ push_gr, push_gr, push_gr, push_gr,
    ...
    /* 0xe8 - 0xeb*/ call_rel, jmp_near, inv, inv,
...
instr_func group_1_bv_entry[8] =
    {inv,inv,inv,inv,inv,inv,inv,cmp_i2rm_bv};/*add_i2rm_v, or_i2rm_v, adc_i2rm_v, sbb_i2rm_v, and_i2rm_v, sub_i2rm_v, xor_i2rm_v, cmp_i2rm_v}*/
/* 0xc0 */
